    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        NagSuppressions.add_resource_suppressions(
            ...
            suppressions=[
                {
                    "id": 'AwsSolutions-IAM5',
                    "reason": 'SageMaker execution role needs all actions to write/read experiments/runs and register models',
                    "applies_to": [
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            suppressions=[
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "SageMaker execution role needs read/write access to the bucket where models can be stored or data be read",
                }
            ],
        )
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            suppressions=[
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "Managed MLflow needs read/write access to the specified bucket to write model weights",
                }
            ],
        )
            ...
            suppressions=[
                {
                    ...
                    "reason": 'Allows SageMakerFullAccess to allow full range of SageMaker actions',
                    "appliesTo": [
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            suppressions=[
                {
                    "id": "AwsSolutions-IAM4",
                    "reason": "Necessary role for the lambda for the customer resource",
                    "appliesTo": [
                ...
                {
                    "id": 'AwsSolutions-L1',
                    "reason": 'Lambda function is generated by CDK, no control over the runtime version'
                },
                {
                    "id": 'AwsSolutions-IAM5',
                    "reason": "Policies are set by Custom Resource and are needed to manage the bucket where we store assets.",
                },
            ]
        )
